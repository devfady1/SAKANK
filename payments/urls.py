...
urlpatterns = [
    ...
    path('manual-order/<int:order_id>/', views.MultiManualPaymentView.as_view(), name='multi_manual_payment'),
    ...
    path('create-order-checkout-session/', views.create_order_checkout_session, name='create_order_checkout_session'),
